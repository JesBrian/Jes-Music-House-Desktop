...
<script>
  import language from '../../../assets/utils/language.js'
  import mimes from '../../../assets/utils/mimes.js'
  import data2blob from '../../../assets/utils/data2blob.js'
  import effectRipple from '../../../assets/utils/effectRipple.js'
