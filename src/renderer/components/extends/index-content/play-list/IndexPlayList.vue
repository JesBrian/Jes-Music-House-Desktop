<template>
  <div>
    ...
    <div style="margin-bottom:28px; padding:0 68px; box-sizing:border-box;">
      <span style="width:138px; margin-top:-2px; float:left; text-align:center; font-size:28px; font-weight:700;">{{ nowPlayListStyleLabel }}</span>
...
<script>
  import IndexPlayListStyle from '../../style/IndexPlayListStyle.vue'
