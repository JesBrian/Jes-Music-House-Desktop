<template>
  <ul>
    <li style="margin:2px 0; padding:2px 0 0; box-shadow:inset 0 2px 1px -1px rgba(255, 255, 255, 0.2), inset 0 -2px 1px -1px rgba(0, 0, 0, 0.2), 0 6px 6px rgba(0, 0, 0, 0.5), inset 0 0 0 1px #272727; line-height:31px;">
    ...
    <li v-for="n in 108" class="box-shadow" style="padding:2px 0;">
      <song-item :index="n" />
    </li>
  </ul>
</template>
